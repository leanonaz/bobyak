...
##  프로젝트 소개
"밥약"은 교내 밥 친구 찾기 웹페이지입니다. 학우들 간 '밥 약속'을 일컫는 '밥약'이라는 단어에서 착안하여 학교에서 함께 밥 먹을 친구를 찾음으로써 교내 교류 활성화 취지로 제작하였습니다. "당신의 학교 생활에 필요한 처방, 밥약"을 슬로건 삼아 '밥 친구 찾기', '맛집 팟 참여', '밥BTI 테스트' 3가지 영역을 중심으로 서비스를 제공할 수 있도록 레이아웃을 구성하였습니다. 사용자는 일대일로 식사 상대를 찾거나, 사용자가 원하는 특정 맛집에 가는 모임에 참여할 수 있습니다. 밥BTI 테스트의 경우 사용자의 식사 성향을 알 수 있도록 테스트 결과를 제공합니다. 
